...
The [verified combinations](https://github.com/albovsky/lethen/blob/3.8.1/README.md#verified-combinations) separate toolchain, project type, host, and evidence. Intel macOS, universal or signed binaries, and running a Swift 6.4-built binary on macOS 15 are unverified.
